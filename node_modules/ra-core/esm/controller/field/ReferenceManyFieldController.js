...
var ReferenceManyFieldController = /** @class */ (function (_super) {
    ...
    ReferenceManyFieldController.prototype.fetchReferences = function (_a) {
        var _b = _a === void 0 ? this
            .props : _a, reference = _b.reference, record = _b.record, resource = _b.resource, target = _b.target, perPage = _b.perPage, filter = _b.filter, source = _b.source;
