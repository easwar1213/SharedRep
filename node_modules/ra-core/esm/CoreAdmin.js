...
var CoreAdmin = /** @class */ (function (_super) {
        ...
        return (React.createElement(TranslationProvider, null,
            React.createElement(ConnectedRouter, { history: this.history },
                React.createElement(Switch, null,
                    React.createElement(Route, { exact: true, path: "/login", render: function (props) {
    ...
    CoreAdmin.prototype.render = function () {
        return this.reduxIsAlreadyInitialized ? (this.renderCore()) : (React.createElement(Provider, { store: createAdminStore(__assign({}, this.props, { history: this.history })) }, this.renderCore()));
    };
    CoreAdmin.propTypes = {
