...
var CoreAdmin = /** @class */ (function (_super) {
        ...
        return (react_1.default.createElement(TranslationProvider_1.default, null,
            react_1.default.createElement(react_router_redux_1.ConnectedRouter, { history: this.history },
                react_1.default.createElement(react_router_dom_1.Switch, null,
                    react_1.default.createElement(react_router_dom_1.Route, { exact: true, path: "/login", render: function (props) {
    ...
    CoreAdmin.prototype.render = function () {
        return this.reduxIsAlreadyInitialized ? (this.renderCore()) : (react_1.default.createElement(react_redux_1.Provider, { store: createAdminStore_1.default(__assign({}, this.props, { history: this.history })) }, this.renderCore()));
    };
    CoreAdmin.propTypes = {
        ...
        customSagas: prop_types_1.default.array,
        customReducers: prop_types_1.default.object,
        customRoutes: prop_types_1.default.array,
        dashboard: componentPropType,
        dataProvider: prop_types_1.default.func,
        history: prop_types_1.default.object,
        i18nProvider: prop_types_1.default.func,
